        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="email" name="number" placeholder="Enter your Mobile no.">
              ...
              <input type="text" id="city" name="state" placeholder="Enter your State">

              <div style="padding: 0px;" class="row">
                <div class="col-50">
                  <label for="state">Country</label>
                  <input type="text" id="state" name="country" placeholder="Enter your Country">
                </div>
                <div class="col-50">
                  <label for="zip">Pincode</label>
                  <input type="text" id="zip" name="pincode" placeholder="Enter your Pincode">
                </div>
              </div>
            </div>
