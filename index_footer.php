        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="index.php#Old Book">Old Book</a>
                            </div>
                        </div>
                    </li>
                ...
                <ul>
                    ...
                    <li>+91 9673328004 | +91 8975132553</li>
                    <li>contact@ebook.com</li>
                    <li>Address: Kolhapur 416218</li>
                </ul>

          </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Shubham Bhongale & Sujay Chimane | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;">E - Book</span>
                    <span class="me" style="font-size: 15px;">Management</span></a>
            </div> 
        </div>
    </div>
</footer>